...
function fixture(result='SUCCESS'){
  ...
  const guard=evaluateRc1PreMutationGuard({plan,authorization,stepId,completedPrefixState:state});
  ...
  return {plan,authorization,state,receipt};
}

test('SUCCESS receipt evidence can be verified while preserving Guard V2 state binding',()=>{
  const {plan,authorization,state,receipt}=fixture();
