  ...
  return <main className={styles.shell}>
    <header className={styles.hero}>
      <div>
        ...
        <p><Link href="/oraculum">← voltar ao Oraculum</Link> · <Link href="/oraculum/qa/evidence">Evidence Ledger</Link> · <Link href="/oraculum/qa/readiness">Promotion Readiness</Link> · <Link href="/oraculum/qa/decision">Human Decision</Link> · <Link href="/oraculum/verify">verificar manifesto →</Link></p>
      </div>
