...
export function evaluateRc1Evidence(recordsInput=[]){
  ...
  const gates=Object.freeze([
    ...
    gate('ciBuild','GitHub CI / typecheck / build',STATUS.BLOCKED,'GitHub Actions permanece bloqueado pela Issue #6 (jobs steps=null); nem mesmo uma evidência independente PASS promove este gate.',0),
